...
class SA_RFE(BaseEstimator, MetaEstimatorMixin, SelectorMixin):
...
class RFECV(SA_RFE, MetaEstimatorMixin):
    ...
    def fit(self, X, y):
        ...
        rfe = SA_RFE(estimator=self.estimator,
